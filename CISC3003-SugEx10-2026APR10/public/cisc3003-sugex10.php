...
<head>
    ...
    <title>DC228922 ZHANGJIEDING</title>
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content mdl-color--grey-50">
            ...
            <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--5-col">
                    <div class="mdl-grid" style="padding: 0;">
                        ...
                        <div class="mdl-cell mdl-cell--12-col card-lesson mdl-card mdl-shadow--2dp" style="margin-top: 0;">
        ...
        <footer class="page-footer-custom">
            CISC3003 Web Programming: DC228922 ZHANGJIEDING 2026
        </footer>
    </main>
</div>
